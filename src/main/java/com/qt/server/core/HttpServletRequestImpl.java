...
import com.qt.server.HttpExchangeRequest;
...
public class HttpServletRequestImpl implements HttpServletRequest {
    ...
    public String getMethod() {
        return this.httpExchangeRequest.getMethod();
    }
    ...
    public String getQueryString() {
        return this.httpExchangeRequest.getRequestURI().getQuery();
    }
    ...
    public String getParameter(String s) {
        return this.httpExchangeRequest.getParameter(s);
    }
